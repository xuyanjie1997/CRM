   ...
   <legend>客户信息--维护信息</legend>
    ...
    <form class="layui-form" method="post">
			...
			<div class="layui-form-item">
				<span class="layui-form-label">商品编号</span>
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" required placeholder="请输入商品名" autocomplete="off"
                    class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="cost" placeholder="请输入价格" autocomplete="off"
                    class="layui-input">
            </div>
        </div>		
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="num" placeholder="请输入库存" autocomplete="off"
                    class="layui-input">
            </div>
        </div>		
...
<script type="text/javascript">
    ...
    function  init() {
		...
		if(code != ''){
			...
			$("input[name='cost']").val("${model.cost}");
			$("input[name='num']").val("${model.num}");
		}else{
			return;
		}
	}
    ...
    formSubmit('/mdse/save', 'submit(add)', 'text', function(data) {
    	if (data == 0) {
            layer.msg('添加成功');
            closeThis(3000);
        } else if (data == 1) {
